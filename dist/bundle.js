...
/***/ "./src/components/jokes/jokes.css":
/*!****************************************!*\
  !*** ./src/components/jokes/jokes.css ***!
  \****************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../node_modules/css-loader/dist/runtime/noSourceMaps.js */ \"./node_modules/css-loader/dist/runtime/noSourceMaps.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../node_modules/css-loader/dist/runtime/api.js */ \"./node_modules/css-loader/dist/runtime/api.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__);\n// Imports\n\n\nvar ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));\n// Module\n___CSS_LOADER_EXPORT___.push([module.id, \".jokeDiv{\\r\\n    width: 15%;\\r\\n    background-color: rgb(0, 0, 0);\\r\\n    padding: 2%;\\r\\n    margin: 2%;\\r\\n    border-radius: 0.4em;\\r\\n}\\r\\n.img{\\r\\n    width: 95%;\\r\\n}\\r\\n.text{\\r\\n    color: aliceblue;\\r\\n}\", \"\"]);\n// Exports\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);\n\n\n//# sourceURL=webpack://dca_scoffolding/./src/components/jokes/jokes.css?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"AttriJokes\": () => (/* binding */ AttriJokes),\n/* harmony export */   \"Jokes\": () => (/* binding */ Jokes),\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _jokes_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./jokes.css */ \"./src/components/jokes/jokes.css\");\n\nvar AttriJokes;\n(function (AttriJokes) {\n    AttriJokes[\"text\"] = \"text\";\n})(AttriJokes || (AttriJokes = {}));\nclass Jokes extends HTMLElement {\n    static get observedAttributes() {\n        const attrs = {\n            text: null,\n        };\n        return Object.keys(attrs);\n    }\n    constructor() {\n        super();\n        this.attachShadow({ mode: \"open\" });\n    }\n    connectedCallback() {\n        this.render();\n    }\n    attributeChangedCallback(proptext, _, newValue) {\n        switch (proptext) {\n            default:\n                this[proptext] = newValue;\n                break;\n        }\n    }\n    showJokes() {\n    }\n    render() {\n        var _a;\n        if (this.shadowRoot) {\n            this.shadowRoot.innerHTML = `\r\n            <div class=\"jokeDiv\">\r\n                <img class=\"img\" src=\"/img/chuck.png\">\r\n                <p class=\"text\">${this.text}</p>\r\n            </div>\r\n            `;\n        }\n        const cssJokes = this.ownerDocument.createElement(\"style\");\n        cssJokes.innerHTML = _jokes_css__WEBPACK_IMPORTED_MODULE_0__[\"default\"];\n        (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.appendChild(cssJokes);\n    }\n}\ncustomElements.define(\"my-jokes\", Jokes);\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Jokes);\n\n\n//# sourceURL=webpack://dca_scoffolding/./src/components/jokes/jokes.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Dashboard\": () => (/* binding */ Dashboard)\n/* harmony export */ });\n/* harmony import */ var _components_export__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/export */ \"./src/components/export.ts\");\n/* harmony import */ var _components_button_button__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/button/button */ \"./src/components/button/button.ts\");\n/* harmony import */ var _components_jokes_jokes__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/jokes/jokes */ \"./src/components/jokes/jokes.ts\");\n/* harmony import */ var _services_getCategories__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/getCategories */ \"./src/services/getCategories.ts\");\n/* harmony import */ var _services_getJokes__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/getJokes */ \"./src/services/getJokes.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\n\n\n\n\n\nclass Dashboard extends HTMLElement {\n    constructor() {\n        super();\n        this.attachShadow({ mode: \"open\" });\n    }\n    connectedCallback() {\n        return __awaiter(this, void 0, void 0, function* () {\n            const categories = yield (0,_services_getCategories__WEBPACK_IMPORTED_MODULE_3__.traer_categories)();\n            this.render(categories);\n        });\n    }\n    render(categories) {\n        if (this.shadowRoot)\n            this.shadowRoot.innerHTML = \"\";\n        categories.forEach((cat) => {\n            var _a;\n            const button = this.ownerDocument.createElement(\"my-button\");\n            button.setAttribute(_components_button_button__WEBPACK_IMPORTED_MODULE_1__.AttriButton.name, cat);\n            button.addEventListener(\"click\", () => __awaiter(this, void 0, void 0, function* () {\n                var _b;\n                const jokes = yield (0,_services_getJokes__WEBPACK_IMPORTED_MODULE_4__.traer_jokes)(cat);\n                console.log(jokes);\n                const Joke = this.ownerDocument.createElement(\"my-jokes\");\n                Joke.setAttribute(_components_jokes_jokes__WEBPACK_IMPORTED_MODULE_2__.AttriJokes.text, jokes.value);\n                (_b = this.shadowRoot) === null || _b === void 0 ? void 0 : _b.appendChild(Joke);\n            }));\n            (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.appendChild(button);\n        });\n    }\n}\ncustomElements.define(\"app-dashboard\", Dashboard);\n\n\n//# sourceURL=webpack://dca_scoffolding/./src/screens/dashboard.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"traer_categories\": () => (/* binding */ traer_categories),\n/* harmony export */   \"traer_jokes\": () => (/* binding */ traer_jokes)\n/* harmony export */ });\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nfunction traer_categories() {\n    return __awaiter(this, void 0, void 0, function* () {\n        try {\n            const categories = yield fetch(\"https://api.chucknorris.io/jokes/categories\").then(res => res.json());\n            return categories;\n        }\n        catch (error) {\n            console.log(error);\n        }\n    });\n}\nfunction traer_jokes(name) {\n    return __awaiter(this, void 0, void 0, function* () {\n        try {\n            const categories = yield fetch(\"https://api.chucknorris.io/jokes/random?category={\" + name + \"}\").then(res => res.json());\n            return categories;\n        }\n        catch (error) {\n            console.log(error);\n        }\n    });\n}\n\n\n//# sourceURL=webpack://dca_scoffolding/./src/services/getCategories.ts?");

/***/ }),

/***/ "./src/services/getJokes.ts":
/*!**********************************!*\
  !*** ./src/services/getJokes.ts ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"traer_jokes\": () => (/* binding */ traer_jokes)\n/* harmony export */ });\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nfunction traer_jokes(name) {\n    return __awaiter(this, void 0, void 0, function* () {\n        try {\n            const categories = yield fetch(\"https://api.chucknorris.io/jokes/random?category=\" + name).then(res => res.json());\n            return categories;\n        }\n        catch (error) {\n            console.log(error);\n        }\n    });\n}\n\n\n//# sourceURL=webpack://dca_scoffolding/./src/services/getJokes.ts?");
